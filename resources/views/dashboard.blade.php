                            ...
                            <div class="row pb-2">
                                ...
                                <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                    <div class="avatar-item mb-0">
                                        ...
                                        <div class="avatar-badge" title="" data-toggle="tooltip"
                                            data-original-title="Admin"><i class="fas fa-cog"></i></div>
                                    </div>
                                </div>
                                <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                    <div class="avatar-item mb-0">
                        ...
                        <div class="card-body">
                            <div id="visitorMap"
                                style="position: relative; overflow: hidden; background-color: rgb(255, 255, 255);"><svg
                                    width="314.5" height="210">
                                    <g transform="scale(0.3310526315789474) translate(0, 42.170111287758324)">
                                        <path
                                        ...
                                        <path d="M613.01,398.99l-1.52,1.99l0.3,2.15l3.2-2.61L613.01,398.99L613.01,398.99z"
                                            ...
                                            original="#ddd" id="jqvmap1_mu" class="jqvmap-region"></path>
                                        <path
                                            d="M607.38,402.37l-2.28,0.15l-0.15,1.99l1.52,0.31l2.28-1.07L607.38,402.37L607.38,402.37z"
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_re" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_mg" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_km" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_sc" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_mv" class="jqvmap-region"></path>
                                        <path
                                ...
                                <div id="jqvmap1_id_pin" for="id" class="jqvmap-pin"
                                    style="position: absolute; left: 254.278px; top: 118.552px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_my_pin" for="my" class="jqvmap-pin"
                                    style="position: absolute; left: 245.933px; top: 111.638px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_th_pin" for="th" class="jqvmap-pin"
                                    style="position: absolute; left: 237.017px; top: 101.671px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_sy_pin" for="sy" class="jqvmap-pin"
                                    style="position: absolute; left: 177.423px; top: 81.1247px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_eg_pin" for="eg" class="jqvmap-pin"
                                    style="position: absolute; left: 171.28px; top: 89.4738px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_ae_pin" for="ae" class="jqvmap-pin"
                                    style="position: absolute; left: 192.673px; top: 91.5296px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_nz_pin" for="nz" class="jqvmap-pin"
                                    style="position: absolute; left: 291.234px; top: 172.24px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_tl_pin" for="tl" class="jqvmap-pin"
                                    style="position: absolute; left: 260.606px; top: 127.018px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_ng_pin" for="ng" class="jqvmap-pin"
                                    style="position: absolute; left: 151.766px; top: 107.437px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_si_pin" for="si" class="jqvmap-pin"
                                    style="position: absolute; left: 156.341px; top: 68.6092px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_pa_pin" for="pa" class="jqvmap-pin"
                                    style="position: absolute; left: 69.2448px; top: 107.419px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_au_pin" for="au" class="jqvmap-pin"
                                    style="position: absolute; left: 263.166px; top: 151.407px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_ca_pin" for="ca" class="jqvmap-pin"
                                    style="position: absolute; left: 71.832px; top: 40.2413px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_tr_pin" for="tr" class="jqvmap-pin"
                                    style="position: absolute; left: 173.919px; top: 76.6472px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="summary">
                                ...
                                <div class="summary-item">
                                    ...
                                    <ul class="list-unstyled list-unstyled-border">
                                        <li class="media">
                                            <a href="#">
                                                <img class="mr-3 rounded" src="assets/img/products/product-1-50.png"
                                        ...
                                        <li class="media">
                                            <a href="#">
                                                <img class="mr-3 rounded" src="assets/img/products/product-2-50.png"
                                                    alt="product" width="50">
                                            </a>
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            <a href="#">
                                                <img class="mr-3 rounded" src="assets/img/products/product-3-50.png"
                                                    alt="product" width="50">
                                            </a>
                                            <div class="media-body">
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled list-unstyled-border">
                                <li class="media">
                                    ...
                                    <img class="mr-3 rounded-circle" src="assets/img/avatar/avatar-4.png"
                                        alt="avatar" width="50">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    <img class="mr-3 rounded-circle" src="assets/img/avatar/avatar-5.png"
                                        alt="avatar" width="50">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    <img class="mr-3 rounded-circle" src="assets/img/avatar/avatar-2.png"
                                        alt="avatar" width="50">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    <img class="mr-3 rounded-circle" src="assets/img/avatar/avatar-1.png"
                                        alt="avatar" width="50">
                                    <div class="media-body">
                                        <div class="badge badge-pill badge-danger mb-1 float-right">Not Finished</div>
